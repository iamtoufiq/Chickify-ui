        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm ">
                Discover delightful flavors at Chickify Zone. Savor our
                exquisite chicken dishes, meticulously crafted for your palate.
                Indulge in a symphony of tastes that will leave you craving
                more.
              </p>
              <div>
